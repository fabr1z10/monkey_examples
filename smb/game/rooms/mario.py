...
#    cam_node.add(factory.tiled2())
    player = factory.mario2(cam, 7, 32)
    cam_node.add(player)

    state.player_id = player.id
    cam_node.add(factory.line(3, 6, 30))
...
def w11():
    ...
    #cam_node.add(factory.bigshoe(1, 1))
    cam_node.add(factory.p1(0,0))
    cam_node.add(factory.goomba(128,32))
    ...
    cam_node.add(factory.platform(1, 2, 15, 8, 5, 2))
